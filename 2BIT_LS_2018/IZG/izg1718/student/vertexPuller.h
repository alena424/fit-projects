...
struct GPUVertexPullerHead {
  size_t
         offset;  ///< offset in bytes where this attribute starts for first vertex
  size_t stride;  ///< distance in bytes between attributes for two consecutive
                  ///vertices
...
struct GPUVertexPullerConfiguration {
  GPUVertexPullerHead
      heads[MAX_ATTRIBUTES];  ///< reading heads for each vertex attribute
  VertexIndex const*
      indices;  ///< indices to vertices, if it is NULL -> indexing is not used
};
 ...
 * Alternative function in OpenGL is <a
 * href="https://www.opengl.org/sdk/docs/man4/html/glCreateVertexArrays.xhtml">glCreateVertexArrays</a>.
 *
 ...
 *
 * Its alternative functions in OpenGL is <a
 * href="https://www.opengl.org/sdk/docs/man4/html/glBindVertexBuffer.xhtml">glVertexArrayVertexBuffer</a>.
 *
 * This function sets vertex attribute in vertex puller, \see
 * GPUVertexPullerHead GPUVertexPullerConfiguration
 *
 * @param gpu GPU handler
 ...
 *
 * Its alternative function in OpenGL is <a
 * href="https://www.khronos.org/registry/OpenGL-Refpages/gl4/html/glVertexArrayElementBuffer.xhtml">glVertexArrayElementBuffer</a>.
 * Indexing is used in indexed drawing (drawElements).
 *
 * \image html images/drawElements.svg "Difference between indexed and
 ...
 *
 * Its alternative function in OpenGL is <a
 * href="https://www.khronos.org/registry/OpenGL-Refpages/gl4/html/glEnableVertexAttribArray.xhtml">glEnableVertexArrayAttrib</a>.
 *
 * @param gpu    GPU handler
 * @param puller id of vertex puller configuration
 ...
 *
 * Its alternative function in OpenGL is <a
 * href="https://www.khronos.org/registry/OpenGL-Refpages/gl4/html/glEnableVertexAttribArray.xhtml">glDisableVertexArrayAttrib</a>.
 *
 * @param gpu GPU handler
 * @param puller id of vertex puller configuration
 ...
 * \endverbatim
 * Its alternative function in OpenGL is <a
 * href="https://www.khronos.org/registry/OpenGL-Refpages/gl4/html/glBindVertexArray.xhtml">glBindVertexArray</a>.
 *
 * @param gpu GPU handler
