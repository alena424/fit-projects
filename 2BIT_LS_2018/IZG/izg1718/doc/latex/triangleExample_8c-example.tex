\hypertarget{triangleExample_8c-example}{\section{triangle\-Example.\-c}
 ...
 If rendering pipeline works, this example renders one colored triangle. \par
...
\end{DoxyCodeInclude}
When a mouse is moving, these matrices are recomputed.\par
...
\end{DoxyCodeInclude}
Last thing that needs to be done in initialization is creation of empty vertex puller\-: 
\begin{DoxyCodeInclude}
...
\end{DoxyCodeInclude}
\hypertarget{triangleExample.c_Shaders}{}\subsection{Shaders}\label{triangleExample.c_Shaders}
...
\end{DoxyCodeInclude}
Then, it projects generated vertex position into clip-\/space\-: 
\begin{DoxyCodeInclude}
  ...
  \hyperlink{structVec4}{Vec4} position;
  \hyperlink{linearAlgebra_8c_a68a9da6c0c100b70184cd882ace57195}{init\_Vec4}(
      &position,
      -1.f+2.f*(\textcolor{keywordtype}{float})(input->\hyperlink{structGPUVertexShaderInput_aefb64b6657cf209abb7b35fe96d9cd30}{gl\_VertexID}%2),
      -1.f+2.f*(\textcolor{keywordtype}{float})(input->\hyperlink{structGPUVertexShaderInput_aefb64b6657cf209abb7b35fe96d9cd30}{gl\_VertexID}/2),
      0.f,
      1.f);
...
\begin{DoxyCodeInclude}
  \hyperlink{linearAlgebra_8c_a898abc01a7905b120121d45afaba6635}{init\_Vec3}(
      colorAttribute,
      (\textcolor{keywordtype}{float})(input->\hyperlink{structGPUVertexShaderInput_aefb64b6657cf209abb7b35fe96d9cd30}{gl\_VertexID} == 0),
      (\textcolor{keywordtype}{float})(input->\hyperlink{structGPUVertexShaderInput_aefb64b6657cf209abb7b35fe96d9cd30}{gl\_VertexID} == 1),
      (\textcolor{keywordtype}{float})(input->\hyperlink{structGPUVertexShaderInput_aefb64b6657cf209abb7b35fe96d9cd30}{gl\_VertexID} == 2));
\end{DoxyCodeInclude}
