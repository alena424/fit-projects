...
\hypertarget{group__gpu__side_ga3983ddd2c559c1a6d1e1f1f37be3eae0}{\index{Úkoly v gpu části@{Úkoly v gpu části}!gpu\-\_\-compute\-G\-L\-Vertex\-I\-D@{gpu\-\_\-compute\-G\-L\-Vertex\-I\-D}}
\index{gpu\-\_\-compute\-G\-L\-Vertex\-I\-D@{gpu\-\_\-compute\-G\-L\-Vertex\-I\-D}!Úkoly v gpu části@{Úkoly v gpu části}}
\subsubsection[{gpu\-\_\-compute\-G\-L\-Vertex\-I\-D}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Vertex\-Index} gpu\-\_\-compute\-G\-L\-Vertex\-I\-D (
\begin{DoxyParamCaption}
\item[{{\bf Vertex\-Index} const $\ast$const}]{indices, }
\item[{{\bf Vertex\-Shader\-Invocation} const}]{vertex\-Shader\-Invocation}
\end{DoxyParamCaption}
)}}\label{group__gpu__side_ga3983ddd2c559c1a6d1e1f1f37be3eae0}


This function computes gl\-\_\-\-Vertex\-I\-D from vertex shader invocation using indexing. 
...
\subsubsection[{gpu\-\_\-compute\-Screen\-Space\-Barycentrics}]{\setlength{\rightskip}{0pt plus 5cm}void gpu\-\_\-compute\-Screen\-Space\-Barycentrics (
\begin{DoxyParamCaption}
...
\end{DoxyParamCaption}
)}}\label{group__gpu__side_gad1769dca11910a684a6ddaad188f3e3d}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000007}{Todo}]V této funkci spočtěte barycentrické coordináty trojúhelníku v obrazovce. Coordináty zapište do coords. V proměnné vertices naleznete pozice vrcholů ve 2\-D v obrazovce. V proměnné lines naleznete rovnice přímek hran trojúhelníka. Rovnice přímek jsou normalizované (velikost normály je 1). Normála směřuje směrem dovnitř trojúhelníka. \end{DoxyRefDesc}
\hypertarget{group__gpu__side_ga4b894f26ed3c06346da10fc6c41f90eb}{\index{Úkoly v gpu části@{Úkoly v gpu části}!gpu\-\_\-compute\-Vertex\-Attribute\-Data\-Pointer@{gpu\-\_\-compute\-Vertex\-Attribute\-Data\-Pointer}}
...
\subsubsection[{gpu\-\_\-compute\-Vertex\-Attribute\-Data\-Pointer}]{\setlength{\rightskip}{0pt plus 5cm}void const$\ast$ gpu\-\_\-compute\-Vertex\-Attribute\-Data\-Pointer (
\begin{DoxyParamCaption}
\item[{{\bf G\-P\-U\-Vertex\-Puller\-Head} const $\ast$const}]{head, }
\item[{{\bf Vertex\-Index} const}]{gl\-\_\-\-Vertex\-I\-D}
\end{DoxyParamCaption}
)}}\label{group__gpu__side_ga4b894f26ed3c06346da10fc6c41f90eb}
...
\hline
{\em gl\-\_\-\-Vertex\-I\-D} & vertex index \\
\hline
\end{DoxyParams}
\begin{DoxyRefDesc}{Todo}
...
\hypertarget{group__gpu__side_ga5eb10381738a5e0426b2811820bc9483}{\index{Úkoly v gpu části@{Úkoly v gpu části}!gpu\-\_\-run\-Primitive\-Assembly@{gpu\-\_\-run\-Primitive\-Assembly}}
\index{gpu\-\_\-run\-Primitive\-Assembly@{gpu\-\_\-run\-Primitive\-Assembly}!Úkoly v gpu části@{Úkoly v gpu části}}
\subsubsection[{gpu\-\_\-run\-Primitive\-Assembly}]{\setlength{\rightskip}{0pt plus 5cm}void gpu\-\_\-run\-Primitive\-Assembly (
\begin{DoxyParamCaption}
...
\end{DoxyParamCaption}
)}}\label{group__gpu__side_ga5eb10381738a5e0426b2811820bc9483}
...
\hypertarget{group__gpu__side_ga0e0c36548db12eea1e6d512b9f855a1c}{\index{Úkoly v gpu části@{Úkoly v gpu části}!gpu\-\_\-run\-Vertex\-Puller@{gpu\-\_\-run\-Vertex\-Puller}}
\index{gpu\-\_\-run\-Vertex\-Puller@{gpu\-\_\-run\-Vertex\-Puller}!Úkoly v gpu části@{Úkoly v gpu části}}
\subsubsection[{gpu\-\_\-run\-Vertex\-Puller}]{\setlength{\rightskip}{0pt plus 5cm}void gpu\-\_\-run\-Vertex\-Puller (
\begin{DoxyParamCaption}
...
\item[{{\bf Vertex\-Shader\-Invocation} const}]{vertex\-Shader\-Invocation}
\end{DoxyParamCaption}
)}}\label{group__gpu__side_ga0e0c36548db12eea1e6d512b9f855a1c}
